...
class SqlProcessorScalarTest extends TestCase
{
	...
	public function provideInvalidData()
	{
		return [
			...
			['s', new stdClass(), 'Modifier %s expects value to be string, object given.'],
			...
			['s[]', new stdClass(), 'Modifier %s[] expects value to be array, object given.'],
			...
			['i', new stdClass(), 'Modifier %i expects value to be int, object given.'],
			...
			['i[]', new stdClass(), 'Modifier %i[] expects value to be array, object given.'],
			...
			['f', new stdClass(), 'Modifier %f expects value to be float, object given.'],
			...
			['f[]', new stdClass(), 'Modifier %f[] expects value to be array, object given.'],
			...
			['b', new stdClass(), 'Modifier %b expects value to be bool, object given.'],
			...
			['b[]', new stdClass(), 'Modifier %b[] expects value to be array, object given.'],
			...
			['dt', new stdClass(), 'Modifier %dt expects value to be DateTime, object given.'],
			...
			['dt[]', new stdClass(), 'Modifier %dt[] expects value to be array, object given.'],
			...
			['dts', new stdClass(), 'Modifier %dts expects value to be DateTime, object given.'],
			...
			['dts[]', new stdClass(), 'Modifier %dts[] expects value to be array, object given.'],
			...
			['any', new stdClass(), 'Modifier %any can handle pretty much anything but not object.'],
		];
	}
